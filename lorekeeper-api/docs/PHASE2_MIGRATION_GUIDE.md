...
python -m lorekeeper.main

# If using Docker
docker-compose restart api

# If using uvicorn directly
uvicorn lorekeeper.main:app --reload
```
...
uvicorn lorekeeper.main:app --port 8001
```
...
from lorekeeper.services.claim_extractor import extract_claims_from_snippet
