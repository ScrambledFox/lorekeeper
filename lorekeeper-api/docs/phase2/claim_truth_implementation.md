...
from lorekeeper.schemas import (
...
def create_claim(world_id: UUID, claim_create: ClaimCreate, db: Session = Depends(get_db)):
    ...
    from lorekeeper.services.contradiction_detector import check_claim_contradictions
...
```python
from lorekeeper.routes import claims
...
from lorekeeper.schemas import ClaimCreate
...
from lorekeeper.schemas import ClaimCreate, ClaimTruthEnum
